            ...
            <div className='flex items-center justify-end gap-3'>
              {prevURL &&
                <button
                  ...
                  className='group flex items-center justify-center gap-2 text-transparent bg-gradient-to-br bg-clip-text from-blue-500 to-pink-500'>
              ...
              {nextURL && 
                <button
                  ...
                  className='group flex items-center justify-center gap-2 text-transparent bg-gradient-to-br bg-clip-text from-blue-400 to-pink-400'>
                  Next <FaArrowRightLong className='text-blue-400 group-hover:translate-x-2 duration-200 transition-all ease-in-out' />
                </button>
              }
              </div>
          ...
          data.map((item, i) => (
            <div className='w-[90%] border-x border-b border-slate-300 mx-auto flex items-center justify-start '>
              ...
              <div className='w-[15%] border-r border-slate-300 px-3 py-2'>
                {role && role.map((i, key) => (i.level == item.role_level && i.name ))}
              </div>
