    ...
    <div>
      ...
      <section className='w-[100%]'>
          <div className='w-[90%] mx-auto flex items-center justify-center'>
            <h6 className='text-center font-black text-[3rem] pt-[3rem] pb-[2rem] text-transparent bg-gradient-to-br bg-clip-text from-blue-500 to-pink-600'>
              App Info Edit</h6>
          </div>
      </section>
      ...
      <section className='w-[100%]'>
          <div className='mx-auto w-[90%] flex items-center justify-end'>
            <Link href='/admin/app-info' className='link__one'>
              View App Info
            </Link>
          </div>
      </section>
