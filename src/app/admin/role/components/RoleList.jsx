...
if(!data){
  ...
  return (
    <div>
            ...
            <div className='flex items-center justify-end gap-3'>
              {prevURL && 
                <button 
                  ...
                  className='group flex items-center justify-center gap-2 text-transparent bg-gradient-to-br bg-clip-text from-blue-600 to-pink-500'>
      ...
      {/* TABLE TITLES */}
      <section className='w-[100%]'>
        <div className='w-[90%] mx-auto flex items-center justify-start font-bold font-white bg-slate-100 '>
