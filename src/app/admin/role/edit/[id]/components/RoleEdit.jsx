          ...
          <div className='mx-auto w-[90%]'>
              ...
              <div className='mb-6'>
                  ...
                  <select
                    ...
                    <option value={5} selected={data.level === 5 && 'selected'}>5</option>
                    <option value={6} selected={data.level === 6 && 'selected'}>6</option>
                    <option value={7} selected={data.level === 7 && 'selected'}>7</option>
                  </select>
              </div>
