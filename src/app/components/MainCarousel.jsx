        ...
        <div className='w-[100%] relative z-0'>
            <div className=''>
                <Swiper
                    ...
                    <SwiperSlide>
                    <div 
                        style={{ backgroundImage: `url('/assets/img/carousel/01.jpg')`}}
                        ...
                        <section className='mx-auto w-[94%] h-[100%] flex flex-col items-start justify-center'>
                            ...
                            <div className='px-3 py-2'>
                                <Link href='#' className='py-5 px-12 flex items-center justify-center gap-2 group rounded-full text-white bg-gradient-to-br from-blue-600 to-pink-600 hover:from-pink-600 hover:to-blue-600 drop-shadow-lg'>
                    ...
                    <SwiperSlide>
                    <div 
                        style={{ backgroundImage: `url('/assets/img/carousel/02.jpg')`}}
                    ...
                    <SwiperSlide>
                    <div 
                        style={{ backgroundImage: `url('/assets/img/carousel/03.jpg')`}}
                        className='w-full h-[34rem] bg-cover bg-gradient-to-br from-pink-200 to-pink-500'>
                        <section className='mx-auto w-[94%] h-[100%] flex flex-col items-start justify-center'>
                            <h5 className='px-3 py-2 text-[3.5rem] font-bold leading-none w-[50%]'>
                                Lorem ipsum dolor sit amet.
